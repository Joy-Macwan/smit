  ...
  return (
    <>
      ...
      <div className="billing">
        ...
        <form onSubmit={addToBill} className="billing-form">
          ...
          <div className="form-row button-row">
            ...
            {billItems.length > 0 && (
              <>
                ...
                <button type="button" onClick={handleEmailPDF}>✉️ Email PDF</button>
              </>
            )}
          </div>
        </form>

        <div className="pdf-container" ref={invoiceRef}>
            ...
            {billItems.length > 0 && (
              <>
                ...
                <div className="summary">
                  ...
                  <p>Total Tax: ₹{getTotalTax().toFixed(2)}</p>
                  <p>Total Discount: ₹{getTotalDiscount().toFixed(2)}</p>
                  <h3>Grand Total: ₹{getGrandTotal()}</h3>
                  <p style={{ color: '#28a745' }}>Profit (10%): ₹{getProfit()}</p>
                </div>
              </>
            )}
          </div>
